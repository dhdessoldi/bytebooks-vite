				...
				<div className='flex m-4 justify-between mt-10 items-center max-w-lg w-full'>
					...
					<div className='flex-row items-center '>
						...
						<div className='flex items-center'>
							<button onClick={() => changeQuantity(book, book.quantity - 1)} disabled={book.quantity === 1}>
								<MdOutlineRemoveCircle className={`${book.quantity === 1 ? 'text-gray-300' : 'text-[#002F52]'} h-8 w-8`} />
							</button>
